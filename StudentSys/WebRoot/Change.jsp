  ...
  <form method="get" action="StudentChangeServlet">
    ...
    <table>
    	...
    	<tr>        <td><select name="id">
        			...
        			<td><input type="text" name="changemajor" /></td>
        			<td><input type="submit" value="修改"/></td>
        		</tr>	
        		 </form>
        		  </table>  
        		  </br>
  		    <div align="center"><input type = "button" style="font-size:1.4em; color:#000000;padding:10px 40px;border-radius: 5px;"value = "重置" onclick = "window.location.href = 'Change.jsp?id=id'"></div>	
  </body>
</html>